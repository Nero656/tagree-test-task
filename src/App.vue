<template>
  <div id="app">
    <div id="nav">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 884.98 190.9"  >
        <g fill="currentColor">
...
<style>
@font-face {
  font-family: Bodoni-Bold; /* Имя шрифта */
  src: url(/resources/fonts/Bodoni-Bold.woff); /* Путь к файлу со шрифтом */
}
